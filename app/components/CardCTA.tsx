    ...
    <div className="card-cta bg-red-500 p-10 flex justify-center items-center">
        <div className="flex flex-col lg:flex-row justify-between items-center max-w-6xl">
            <div className="relative flex-shrink-0 w-[420px] h-[350px] m-10">
                ...
                <Image src="/images/CardCTA/star-3.a6b54be6.svg" alt="Star" width={30} height={22} className="absolute top-13 right-90"/>
                <Image src="/images/CardCTA/star-3.a6b54be6.svg" alt="Star" width={30} height={22} 
            ...
            <div className="flex flex-col m-10 max-w-[500px]">
                <h1 className="text-3xl text-white font-bold">
                    Let's make our dreams come true!
                </h1>
                <p className="text-2xl text-gray-300 my-6">
                ...
                <div className="block my-1 ">
                    <Link href="/auth/login">
                        <button className="bg-white border border-white text-red-500 font-bold py-2 px-6 rounded hover:bg-red-500 hover:text-white transition duration-400 ease-out-in cursor-pointer">
                            Đăng ký ngay
                        </button>
                    </Link>
                </div>
